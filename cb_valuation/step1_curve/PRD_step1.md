...
## What (범위)
입력: 채권평가사 시가평가 기준수익률 매트릭스(3M…50Y 16테너, %, '-' 결측), 평가기준일·커브 기준일, 상품 정보(발행형태 공모/사모, 신용등급, 만기, 풋/콜일), 보고서 헤드라인(선택).
...
- 골든 재현: fixture A(라이브 KIS-NET) TOL_GOLDEN_ABS.A, B(엑셀 캐시, EXCEL_KBI) .B, C(검토자 2024-12-31, REVIEWER_2024) .C_*, D(한공회 2023-05-03, KICPA_1130) .D.
