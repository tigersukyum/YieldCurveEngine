...
| `boot_cached_20251231.json` | KBI xlsm `BOOT` 캐시값(G/V stale 이표율, H/I/W/X/L/M/N/AA/AB/AC) | EXCEL_KBI | fixture **B** 엑셀 재조정(≤TOL_EXCEL_RECON), MF_INTERPOL 프로브, 헤드라인 ceil_tenor 2.765/11.854 |
